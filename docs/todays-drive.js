...
var CustardDrive = (function () {
  ...
  function buildShellHtml() {
    return ''
      ...
      +       '<button type="button" id="drive-use-location" class="btn-secondary btn--sm">Use Location</button>'
      ...
      +       '<button type="button" id="drive-add-store-btn" class="btn-secondary btn--sm">Add</button>'
      +       '<button type="button" id="drive-reset-btn" class="btn-secondary btn--sm btn--muted" title="Reset route and preferences to defaults">Reset</button>'
      +     '</div>'
      +   '</div>'
      ...
      +       '<button type="button" id="drive-retry" class="btn-secondary btn--sm drive-retry" hidden>Try again</button>'
      +     '</div>'
